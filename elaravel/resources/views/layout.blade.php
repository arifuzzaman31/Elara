            ...
            <div class="col-sm-8">
                <div class="shop-menu pull-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{url('customer-logout')}}"><b>{{ Session::get('customer_name') }}</b> <i class="fa fa-lock"></i> Logout</a></li>
                        ...
                        @else
                        <li><a href="{{url('checkout-login')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                        <li><a href="{{url('checkout-login')}}"><i class="fa fa-lock"></i>Login</a></li>
                        @endif
                    </ul>
                </div>
            </div>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="{{url('checkout-login')}}">Checkout</a></li> 
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <?php $categories = DB::table('tbl_category')->where('publication_status',1)->get();
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <?php $brands = DB::table('tbl_manufacture')
                                    ->where('publication_status',1)->get();
                                    foreach ($brands as $brand) { ?>
                                    <li><a href="{{url('product-by-manufacture',$brand->manufacture_id)}}"> <span class="pull-right">{{rand(25,50)}}</span>{{$brand->manufacture_name}}</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div><!--/brands_products-->
                ...
                <div class="col-sm-9 padding-right">
                    ...
                    @yield('content') <!--/recommended_items-->
